...
${OBJECTDIR}/Auxiliary/auxFunc.o: Auxiliary/auxFunc.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Auxiliary/auxFunc.o Auxiliary/auxFunc.c

${OBJECTDIR}/Auxiliary/complex.o: Auxiliary/complex.c 
	${MKDIR} -p ${OBJECTDIR}/Auxiliary
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Auxiliary/complex.o Auxiliary/complex.c

${OBJECTDIR}/ImageFilters/clahe.o: ImageFilters/clahe.c 
	${MKDIR} -p ${OBJECTDIR}/ImageFilters
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageFilters/clahe.o ImageFilters/clahe.c

${OBJECTDIR}/ImageFilters/contrast.o: ImageFilters/contrast.c 
	${MKDIR} -p ${OBJECTDIR}/ImageFilters
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageFilters/contrast.o ImageFilters/contrast.c

${OBJECTDIR}/ImageFilters/filters.o: ImageFilters/filters.c 
	${MKDIR} -p ${OBJECTDIR}/ImageFilters
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageFilters/filters.o ImageFilters/filters.c

${OBJECTDIR}/ImageFilters/fourier.o: ImageFilters/fourier.c 
	${MKDIR} -p ${OBJECTDIR}/ImageFilters
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageFilters/fourier.o ImageFilters/fourier.c

${OBJECTDIR}/ImageFilters/mask.o: ImageFilters/mask.c 
	${MKDIR} -p ${OBJECTDIR}/ImageFilters
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageFilters/mask.o ImageFilters/mask.c

${OBJECTDIR}/ImageFilters/transformations.o: ImageFilters/transformations.c 
	${MKDIR} -p ${OBJECTDIR}/ImageFilters
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageFilters/transformations.o ImageFilters/transformations.c

${OBJECTDIR}/ImageProcessing/PointLL.o: ImageProcessing/PointLL.c 
	${MKDIR} -p ${OBJECTDIR}/ImageProcessing
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageProcessing/PointLL.o ImageProcessing/PointLL.c

${OBJECTDIR}/ImageProcessing/RegionLL.o: ImageProcessing/RegionLL.c 
	${MKDIR} -p ${OBJECTDIR}/ImageProcessing
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageProcessing/RegionLL.o ImageProcessing/RegionLL.c

${OBJECTDIR}/ImageProcessing/maxTreshHold.o: ImageProcessing/maxTreshHold.c 
	${MKDIR} -p ${OBJECTDIR}/ImageProcessing
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageProcessing/maxTreshHold.o ImageProcessing/maxTreshHold.c
...
${OBJECTDIR}/Test/peakfinder.o: Test/peakfinder.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test/peakfinder.o Test/peakfinder.c

${OBJECTDIR}/TiffImage/readTiff.o: TiffImage/readTiff.c 
	${MKDIR} -p ${OBJECTDIR}/TiffImage
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TiffImage/readTiff.o TiffImage/readTiff.c

${OBJECTDIR}/TiffImage/tiffFile.o: TiffImage/tiffFile.c 
	${MKDIR} -p ${OBJECTDIR}/TiffImage
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TiffImage/tiffFile.o TiffImage/tiffFile.c

${OBJECTDIR}/TiffImage/writeTiff.o: TiffImage/writeTiff.c 
	${MKDIR} -p ${OBJECTDIR}/TiffImage
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TiffImage/writeTiff.o TiffImage/writeTiff.c
