...
${OBJECTDIR}/InputImages/complex.o: InputImages/complex.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputImages/complex.o InputImages/complex.c

${OBJECTDIR}/InputImages/fourier.o: InputImages/fourier.c 
	${MKDIR} -p ${OBJECTDIR}/InputImages
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputImages/fourier.o InputImages/fourier.c
